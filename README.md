...
## Box_146x30x27
A parametric box for short USB cables, jumper wires, pens, etc.

## Box_73x60x35
A parametric box for electronics like Feather, Grove, Pi Zero, QT Py, Xiao, etc.

## Box_73x180x34.5
A parametric box for bigger tools, the size of 3 [Box_73x60x35]().
